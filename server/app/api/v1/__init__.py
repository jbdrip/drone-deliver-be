...
from app.api.v1 import auth, user, customer, distribution_center, product, credit_transaction, order
...
api_router.include_router(order.router, prefix="/orders", tags=["orders"], dependencies=[Depends(get_current_user)])