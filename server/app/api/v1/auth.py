...
from app.schemas.auth import LoginReq, RegisterReq, Token, PasswordResetRequest, PasswordReset
...
def reset_user_password(request: PasswordReset, db: Session = Depends(get_db)):
